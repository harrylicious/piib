...
//====================================================> Halaman
	...
	public function index(){
		if($this->session->userdata('access')=='1'){
			...
			$data['judul']='Beranda super';
			$data['data']=$this->m_user->get_profile($id_user);
			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_dashboard',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
	...
	public function profile(){
		if($this->session->userdata('access')=='1'){
			...
			$data['data']=$this->m_user->get_profile($id_user); 
			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_profile',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
			$this->load->view('/maintenance/v_error_404');
		}
	...
	public function admin_user(){
		if($this->session->userdata('access')=='1'){
			...
			$limit=10;
			$data['data']=$this->m_user->get_profile($id_user);
			$data['data_user']=$this->m_user->get_admin_user($limit); 
			$this->db->where('level', 'admin'); 
			$this->db->where('status', '0'); 
			$data['hitung']= $this->db->count_all_results($tbl); 
			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_admin_user',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
			$this->load->view('/maintenance/v_error_404');
		}
	...
	public function mentor_user(){
		if($this->session->userdata('access')=='1'){
			...
			$data['hitung']= $this->db->count_all_results($tbl); 
			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_mentor_user',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
			$this->load->view('/maintenance/v_error_404');
		}
	...
	public function peserta_user(){
		if($this->session->userdata('access')=='1'){
			...
			$data['hitung']= $this->db->count_all_results($tbl); 
			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_peserta_user',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
			$this->load->view('/maintenance/v_error_404');
		}
	...
	public function admin_user_profile($id_admin){
		if($this->session->userdata('access')=='1'){
			$id_user=$this->session->userdata('u_id');
			$data['judul']='Profil admin';
			$tbl=$this->m_config->tbl_user();
			$data['data']=$this->m_user->get_profile($id_user);
			$data['data_admin']=$this->m_user->get_admin_user_profile($id_admin); 
			$this->db->where('level', 'admin'); 
			$data['hitung']= $this->db->count_all_results($tbl);

			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_admin_profile',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
			$this->load->view('/maintenance/v_error_404');
		}
	...
	public function mentor_user_profile($id_mentor){
		if($this->session->userdata('access')=='1'){
			...
			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_mentor_profile',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
			$this->load->view('/maintenance/v_error_404');
		}
	...
	public function peserta_user_profile($id_peserta){
		if($this->session->userdata('access')=='1'){
			...
			$this->load->view('/templates/super/v_header',$data);
			$this->load->view('/home/super/v_peserta_profile',$data);
			$this->load->view('/templates/super/v_footer',$data);
		}else{
			$this->load->view('/maintenance/v_error_404');
		}
...
// hapus akun admin
	public function delete_admin($id_admin){
		if($this->session->userdata('access')=='1'){
			...
			$this->m_user->delete($id_admin, $data);

				// sesi tab
			$this->session->set_tempdata('tab', '2', 2);

			echo $this->session->set_tempdata('msg','<div class="alert alert-success" role="alert"> Admin berhasil dihapus </div>', 2);
			redirect("super/admin_user");
...
} /*ini adalah batas class Super / this line is limit of Class Super*/
