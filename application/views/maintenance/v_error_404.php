 ...
 <div class="container d-flex flex-column">
     <div class="row">
         <div class="offset-xl-1 col-xl-2 col-lg-12 col-md-12 col-12">
             <div class="mt-4">
             <a href="<?= base_url();?>index.html"><img src="<?= base_url();?>assets/images/piib/Piib_logo.png" width="90px" weight="40px" alt=""></a>
            </div>
         </div>
     </div>
  <div class="row align-items-center justify-content-center no-gutters py-lg-22 py-10">
   ...
   <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-12 col-12 text-center text-lg-left">
    ...
    <p class="mb-5 lead">Ups! Maaf, kami tidak dapat menemukan halaman yang Anda cari. Jika menurut Anda ini masalah dengan kami, silakan <a href="#" class="btn-link">Hubungi kami</a></p>
    <a href="<?= base_url();?>index.html" class="btn btn-primary mr-2">Kembali</a>
   </div>
   <!-- img -->
   <div class="offset-xl-1 col-xl-6 col-lg-6 col-md-12 col-12 mt-8 mt-lg-0">
    <img src="<?= base_url();?>assets/images/error/404-error-img.svg" alt="" class="w-100" />
   </div>
  </div>
  <div class="row">
    <div class="offset-xl-1 col-xl-10 col-lg-12 col-md-12 col-12">
        ...
        <p class="mb-0">© Team PIIB. 2021 Codescandy.</p>
    </div>
