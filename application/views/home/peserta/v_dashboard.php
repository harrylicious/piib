		...
		<div class="tab-pane fade" id="path" role="tabpanel" aria-labelledby="path-tab">
			<div class="row  d-flex justify-content-center text-center">
				<div class="col-xl-5 col-lg-5 col-md-12 col-12">
					<div class="py-6">
						<img src="<?= base_url() ?>assets/images/svg/path-img.svg" alt="" class="img-fluid">
						<div class="mt-4 ">
							...
							<a href="<?= base_url() ?>index.html" class="btn btn-primary">
								Back To Dashboard
							</a>
						</div>
					</div>
				...
				<div class="card mb-4">
					...
					<div class="table-responsive ">
						<table class="table mb-0">
									...
									<td class="align-middle">
										<a href="#!">
											<div class="d-lg-flex align-items-center">
												<img src="<?= base_url() ?>assets/images/course/course-laravel.jpg" alt="" class="rounded img-4by3-lg" />
							...
							<tr>
								<td class="align-middle">
									<a href="#!">
										<div class="d-lg-flex align-items-center">
											<img src="<?= base_url() ?>assets/images/course/course-sass.jpg" alt="" class="rounded img-4by3-lg" />
											<h5 class="mb-0 ml-lg-3 mt-2 mt-lg-0 text-primary-hover">
						...
						<tr>
							<td class="align-middle">
								<a href="#!">
									<div class="d-lg-flex align-items-center">
										<img src="<?= base_url() ?>assets/images/course/course-vue.jpg" alt="" class="rounded img-4by3-lg" />
										<h5 class="mb-0 ml-lg-3 mt-2 mt-lg-0 text-primary-hover">
					...
					<tr>
						<td class="align-middle">
							<a href="#!">
								<div class="d-lg-flex align-items-center">
									<img src="<?= base_url() ?>assets/images/course/course-react.jpg" alt="" class="rounded img-4by3-lg" />
									<h5 class="mb-0 ml-lg-3 mt-2 mt-lg-0 text-primary-hover">
	...
	<div class="tab-pane fade" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
		<div class="card">
			...
			<!-- 				<th scope="col" class="border-bottom-0">Progress</th>
							...
							<th scope="col" class="border-bottom-0">Telepon</th>
						</tr>
					</thead>
					<tbody>
						<?php foreach ($data_anggota_tim as $row) 
		...
		<!-- 						<td class="align-middle">0%</td>
								...
								<td class="pr-0 align-middle">
									<a href="#!" class="btn btn-outline-white btn-sm"> <?= $row->telpon; ?></a>
								</td>
							</tr>
						<?php } ?>
						</tbody>
		...
		<?php foreach ($data_event as $row) 
		{
			...
			<div class="col-lg-3 col-md-6 col-12">
				...
				<div class="card  mb-4 card-hover">
					<a href="#!" class="card-img-top"><img src="<?= base_url() ?>assets/images/course/course-graphql.jpg" alt=""
