...
<div class="container-fluid p-4">
		...
		<div class="col-lg-12 col-md-12 col-12">
			...
			<div class="border-bottom pb-4 mb-4 d-flex justify-content-between align-items-center">
				...
				<div class="nav btn-group" role="tablist">
					...
					<a href="#!" id="Addpeserta" class="btn btn-outline-success btn-sm"
					data-template="Addpeserta"
					data-toggle="modal"
	...
	<div>
		<input type="text" id="myInput" class="form-control" placeholder="Cari peserta" /><br>
	</div>
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-12">
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade show active" id="tabPaneGrid" role="tabpanel" aria-labelledby="tabPaneGrid">
									...
									<div class="card-body">
										<div class="text-center">
											<div class="position-relative">
												<a href="peserta_user_profile/<?= $id_peserta ?>">
									...
									foreach ($data_user->result_array() as $key ) {
										...
										<tbody id="myTable">
											<tr>
												...
												<td class="align-middle">
													<a href="#Message<?= $id_peserta ?> " 
														data-toggle="modal" data-target="#Message<?= $id_peserta ?>" class="text-muted" data-placement="top" title="Hapus"><i class="fe fe-mail"></i></a>
													</td>
													<td class="align-middle">
														<a href="#DeleteUserModal<?= $id_peserta ?> " 
															data-toggle="modal" data-target="#DeleteUserModal<?= $id_peserta ?>" class="text-muted" data-placement="top" title="Hapus"><i class="fe fe-trash"></i></a>
														</td>
					...
					<div class="modal fade" id="AddpesertaModal" tabindex="-1" role="dialog" aria-labelledby="AddpesertaModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header align-items-center">
									<h4 class="mb-0" id="AddpesertaModalLabel">Tambah peserta</h4>
											...
											<div class="d-flex justify-content-between align-items-center">
												...
												<div class="media-body ml-2">
													<center>
														<div>
															<!-- Form -->
															<form class="form-row" method="post" action="<?= base_url();?>admin/tambah_peserta">
																<!-- NIM -->
																<div class="form-group col-12 col-md-6">
																	<label class="form-label" for="nim">NIM</label>
																	<input name="nim" type="text" id="nim" class="form-control" placeholder="NIM" />
																</div>
																<!-- Nama Lengkap -->
																<div class="form-group col-12 col-md-6">
			...
			foreach ($data_user->result_array() as $key ) {
				...
				?>
				<form action="<?= base_url(); ?>admin/message_peserta/<?= $id_peserta ?> ">
					<div class="modal fade" id="Message<?= $id_peserta?>" tabindex="-1" role="dialog" aria-labelledby="MessageLabel" aria-hidden="true">
						<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header align-items-center">
									...
									<ul class="list-unstyled contacts-list mb-0">
										...
										<li class="py-3 px-4 chat-item contacts-item">
											<div class="d-flex justify-content-between align-items-center">
												...
												<div class="media-body ml-2">
													<center>
														<input type="text" value="<?= $id_peserta ?>" hidden >
			...
			foreach ($data_user->result_array() as $key ) {
				...
				?>
				<form action="<?= base_url(); ?>admin/delete_peserta/<?= $id_peserta ?> ">
					<div class="modal fade" id="DeleteUserModal<?= $id_peserta?>" tabindex="-1" role="dialog" aria-labelledby="DeleteUserModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header align-items-center">
