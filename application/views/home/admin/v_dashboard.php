         	...
         	<div class="row">
         		<div class="col-lg-12 col-md-12 col-12">
         			<div class="border-bottom pb-4 mb-4 d-lg-flex justify-content-between align-items-center">
         				<div>
         					<h1 class="mb-0 h2 font-weight-bold">Beranda</h1>
         				</div>
         		<!-- 		<div class="d-flex">
         			...
         			<div class="card mb-4">
         				...
         				<div class="card-body">
         					<div class="d-flex align-items-center justify-content-between mb-3 lh-1">
         						<div>
         							<span class="font-size-xs text-uppercase font-weight-semi-bold">Peserta</span>
         						</div>
         						<div>
         								<span class=" fe fe-user font-size-lg text-primary"></span>
         						</div>
         					</div>
         		...
         		<div class="col-xl-3 col-lg-6 col-md-12 col-12">
         			...
         			<div class="card mb-4">
         				...
         				<div class="card-body">
         					<div class="d-flex align-items-center justify-content-between mb-3 lh-1">
         						<div>
         							<span class="font-size-xs text-uppercase font-weight-semi-bold">Mentor</span>
         						</div>
         						<div>
         							<span class=" fe fe-user font-size-lg text-primary"></span>
         						</div>
         		...
         		<div class="col-xl-3 col-lg-6 col-md-12 col-12">
         			...
         			<div class="card mb-4">
         				...
         				<div class="card-body">
         					<div class="d-flex align-items-center justify-content-between mb-3 lh-1">
         						<div>
         							<span class="font-size-xs text-uppercase font-weight-semi-bold">Tim</span>
         						</div>
         						<div>
         											...
         											<div class="row">
         												<div class="col-auto">
         													<div class="avatar avatar-md avatar-indicators avatar-online">
         														<img alt="avatar" src="<?= base_url() ?>assets/images/avatar/avatar-2.jpg" class="rounded-circle">
         													</div>
         												</div>
         												<div class="col ml-n3">
         												...
         												<div class="row">
         													<div class="col-auto">
         														<div class="avatar avatar-md avatar-indicators avatar-away">
         															<img alt="avatar" src="<?= base_url() ?>assets/images/avatar/avatar-3.jpg" class="rounded-circle">
         														</div>
         													</div>
         													<div class="col ml-n3">
         													...
         													<div class="row">
         														<div class="col-auto">
         															<div class="avatar avatar-md avatar-indicators avatar-info">
         																<img alt="avatar" src="<?= base_url() ?>assets/images/avatar/avatar-6.jpg" class="rounded-circle">
         															</div>
         														</div>
         														<div class="col ml-n3">
         														...
         														<div class="row">
         															<div class="col-auto">
         																<div class="avatar avatar-md avatar-indicators avatar-busy">
         																	<img alt="avatar" src="<?= base_url() ?>assets/images/avatar/avatar-7.jpg" class="rounded-circle">
         																</div>
         															</div>
         															<div class="col ml-n3">
         												...
         												<ul class="list-group list-group-flush">
         													<li class="list-group-item px-0 pt-0">
         														<div class="row">
         															...
         															<div class="col-auto">
         																<a href="#!">
         																	<img src="<?= base_url() ?>assets/images/course/course-laravel.jpg" alt="" class="img-fluid rounded img-4by3-lg" /></a>
         																</div>
         																<!-- Col -->
         																<div class="col pl-0">
         																	<a href="#!">
         																	...
         																	<div class="d-flex align-items-center">
         																		<img src="<?= base_url() ?>assets/images/avatar/avatar-7.jpg" alt="" class="rounded-circle avatar-xs mr-2" />
         														...
         														<li class="list-group-item px-0">
         															<div class="row">
         																<div class="col-auto">
         																	<a href="#!"><img src="<?= base_url() ?>assets/images/course/course-gatsby.jpg" alt="" class="img-fluid rounded img-4by3-lg" /></a>
         																</div>
         																<div class="col pl-0">
         																	<a href="#!">
         																		<h5 class="text-primary-hover">
         																	...
         																	<div class="d-flex align-items-center">
         																		<img src="<?= base_url() ?>assets/images/avatar/avatar-8.jpg" alt="" class="rounded-circle avatar-xs mr-2" />
         														...
         														<li class="list-group-item px-0">
         															<div class="row">
         																<div class="col-auto">
         																	<a href="#!">
         																		<img src="<?= base_url() ?>assets/images/course/course-javascript.jpg" alt="" class="img-fluid rounded img-4by3-lg" /></a>
         																	</div>
         																	<div class="col pl-0">
         																		<a href="#!">
         																		...
         																		<div class="d-flex align-items-center">
         																			<img src="<?= base_url() ?>assets/images/avatar/avatar-1.jpg" alt="" class="rounded-circle avatar-xs mr-2" />
         															...
         															<li class="list-group-item px-0">
         																<div class="row">
         																	<div class="col-auto">
         																		<a href="#!">
         																			<img src="<?= base_url() ?>assets/images/course/course-wordpress.jpg" alt="" class="img-fluid rounded img-4by3-lg" /></a>
         																		</div>
         																		<div class="col pl-0">
         																			<a href="#!">
         																				<h5 class="text-primary-hover">
         																			...
         																			<div class="d-flex align-items-center">
         																				<img src="<?= base_url() ?>assets/images/avatar/avatar-5.jpg" alt="" class="rounded-circle avatar-xs mr-2" />
         															...
         															<ul class="list-group list-group-flush list-timeline-activity">
         																...
         																<li class="list-group-item px-0 pt-0  border-0 mb-2">
         																	<div class="row">
         																		<div class="col-auto">
         																			<div class="avatar avatar-md avatar-indicators avatar-busy">
         																				<img alt="avatar" src="<?= base_url() ?>assets/images/avatar/avatar-4.jpg" class="rounded-circle">
         																			</div>
         																		</div>
         																		<div class="col ml-n3">
