          		<?php foreach ($data_mentor->result_array() as $key ) {
          			$foto=$key['foto'];
          			$nip=$key['nip'];
          							...
          							<div class="col-md-12">
          								...
          								<ul class="nav nav-lb-tab mb-6" id="tab" role="tablist">
          									<li class="nav-item ml-0" role="presentation">
          										<a class="<?= $link1 ?> " id="profile-tab" data-toggle="pill" href="#profile" role="tab" aria-controls="profile" aria-selected="true"><i class="fe fe-user mr-2"></i>Profil Mentor</a>
          									</li>
          									...
          									<div class="<?= $tab1 ?>" id="profile" role="tabpanel" aria-labelledby="profile-tab">
          										...
          										<div class="card">
          											...
          											<div class="card-header">
          												...
          												<h3 class="mb-0 mt-5">Detail Profil Mentor : <?= $nama_lengkap ?></h3>
          													<!-- <p class="mb-0">
