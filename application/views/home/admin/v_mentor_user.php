...
<div class="container-fluid p-4">
		...
		<div class="col-lg-12 col-md-12 col-12">
			...
			<div class="border-bottom pb-4 mb-4 d-flex justify-content-between align-items-center">
				...
				<div class="nav btn-group" role="tablist">
					...
					<a href="#!" id="AddMentor" class="btn btn-outline-success btn-sm"
					data-template="AddMentor"
					data-toggle="modal"
					data-target="#AddMentorModal"
	...
	<div>
		<input type="text" id="myInput" class="form-control" placeholder="Cari mentor" /><br>
	</div>
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-12">
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade show active" id="tabPaneGrid" role="tabpanel" aria-labelledby="tabPaneGrid">
									...
									<div class="card-body">
										<div class="text-center">
											<div class="position-relative">
												<a href="mentor_user_profile/<?= $id_user ?>">
					...
					<div class="modal fade" id="AddMentorModal" tabindex="-1" role="dialog" aria-labelledby="AddMentorModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header align-items-center">
									<h4 class="mb-0" id="AddMentorModalLabel">Tambah Mentor</h4>
											...
											<div class="d-flex justify-content-between align-items-center">
												...
												<div class="media-body ml-2">
													<center>
														<div>
															<!-- Form -->
															<form class="form-row" method="post" action="<?= base_url();?>admin/tambah_mentor">
																<!-- NIM -->
			...
			foreach ($data_user->result_array() as $key ) {
				...
				?>
				<form action="<?= base_url(); ?>admin/message_mentor/<?= $id_user ?> ">
			...
			foreach ($data_user->result_array() as $key ) {
				...
				?>
				<form action="<?= base_url(); ?>admin/delete_mentor/<?= $id_user ?> ">
