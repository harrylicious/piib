          							...
          							<div class="col-md-12">
          								...
          								<ul class="nav nav-lb-tab mb-6" id="tab" role="tablist">
          									<li class="nav-item ml-0" role="presentation">
          										<a class="<?= $link1 ?> " id="profile-tab" data-toggle="pill" href="#profile" role="tab" aria-controls="profile" aria-selected="true"><i class="fe fe-user mr-2"></i>Profil </a>
          									</li>
          									<li class="nav-item" role="presentation">
          										<a class="<?= $link2 ?>" id="edit-profile-tab" data-toggle="pill" href="#edit-profile" role="tab" aria-controls="edit-profile" aria-selected="true"><i class="fe fe-settings mr-2"></i>Ubah Profil</a>
          									</li>    	
          									<li class="nav-item" role="presentation">
          										<a class="<?= $link3 ?>" id="security-tab" data-toggle="pill" href="#security" role="tab" aria-controls="security" aria-selected="true"><i class="fe fe-lock mr-2"></i>Keamanan</a>
          									</li>       			
			...
			<div class="<?= $tab2 ?>" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
				...
				<div class="card">
							...
							<div class="d-flex align-items-center mb-4 mb-lg-0">
								...
								<div class="ml-3">
									...
									<div class="custom-file">
										<?php echo form_open_multipart(base_url().'super/update_foto');?>
					...
					<form action="<?= base_url();?>super/delete_foto" method="post">
						<!-- Modal hapus foto -->
					...
					<div>
						...
						<!-- Form -->
						<form class="form-row" method="post" action="<?= base_url('super/');?>update_profile">
							<!-- NIP -->
							<div class="form-group col-12 col-md-6">
								<label class="form-label" for="nip">NIP</label>
	...
	<div class="<?= $tab3 ?>" id="security" role="tabpanel" aria-labelledby="security-tab">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form class="form-row" action="<?= base_url();?>super/change_email" method="post">
				...
				<div>
					...
					<!-- Form -->
					<form class="form-row" action="<?= base_url();?>super/change_password" method="post">
