...
<body>
  ...
  <div class="container mt-7">
      ...
      <div class="row">
          ...
          <div class="col-xs-9 offset-4">
            <!-- can 1 -->
            <div class="box-1 box-peserta">
                <a href="<?php echo base_url('auth/register_peserta') ?>">
                    <center>
            ...
            <div class="box-1 box_mentor">
                <a href="<?php echo base_url('auth/register_mentor') ?>">
                    <center>
    ...
    <!--         <div class="box-1 box_ssl">
                <a href="<?php echo base_url('auth/register_admin') ?>">
                    <center>
...
<!--             <div class="box-1 box_sula">
                <a href="<?php echo base_url('auth/register_super') ?>">
                    <center>
