			...
			<div class="col-lg-5 col-md-8 py-8 py-xl-0">
				...
				<div class="card shadow ">
					...
					<div class="card-body p-6">
						...
						<!-- Form -->
						<form  id="form" action="<?= base_url('auth/login_process_peserta') ?>" method="post">
							<!-- Username -->
							...
							<div class="d-lg-flex justify-content-between align-items-center mb-4">
								...
								<div class="mt-2" align="center">
									<span>Belum punya akun ? <a href="<?= base_url('auth/'); ?>register_peserta" class="ml-1">Daftar</a></span>
									<div>                    
										<a href="<?= base_url('auth/');?>forgot_peserta">Lupa passsword?</a>
									</div>                
								</div>                  
							</form>
						</div>
