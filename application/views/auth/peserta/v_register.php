			...
			<div class="col-lg-5 col-md-8 py-8 py-xl-0">
				...
				<div class="card shadow">
					...
					<div class="card-body p-6">
						<div class="mb-4">
							<a href="<?= base_url();?>v-landing.html"><img src="<?= base_url();?>/assets/images/piib/logo-tulisan-samping.png" width="350" weight="150" class="mb-4" alt="logo" /></a>
							<h1 class="mb-1 font-weight-bold"><?= $label ?></h1>							
						</div>
						<!-- Form -->
						<center><?php echo $this->session->tempdata('msg');?></center>
						<form  id="form" action="<?= base_url('auth/register_process_peserta') ?>" method="post">
								<!-- Nama Lengkap -->
							...
							<div class="mt-5" align="center">
								<span>Sudah punya akun?
									<a href="<?= base_url('auth/');?>login_peserta" class="ml-1">Masuk</a></span>
							</div>
							</div>							
						</form>
					</div>
