...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-default">
		<div class="container-fluid px-0">
			<a class="navbar-brand" href="<?= base_url();?>mentor"
...
<li class="dropdown ml-2">
	...
	<div class="avatar avatar-md avatar-indicators avatar-online">
		<img
		alt="avatar"
		src="<?= base_url('assets/images/users/'.$foto);?>"
		class="rounded-circle"
		/>
	</div>
</a>
...
<ul class="list-unstyled">
	...
	<li>
		<a class="dropdown-item" href="<?= base_url();?>mentor/profile">
			<i class="fe fe-user mr-2"></i>Profil
		</a>
	</li>						
	<li>
		<a class="dropdown-item" href="<?= base_url();?>mentor/edit_profile">
