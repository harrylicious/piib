	...
	<div id="db-wrapper">
		...
		<nav class="navbar-vertical navbar">
			<div class="nav-scroller">
				<!-- Brand logo -->
				<a class="navbar-brand" href="<?= base_url();?>super">
					<img src="<?= base_url();?>assets/images/piib/Piib_logo.png" width="120px" weight="90px" alt="" />
				</a>
				<!-- Navbar nav -->
				<ul class="navbar-nav flex-column" id="sideNavbar">
					<li class="nav-item">
						<a class="nav-link  " href="<?= base_url()?>super" data-target="#navDashboard" aria-expanded="false" aria-controls="navDashboard">
							<i class="nav-icon fe fe-home mr-2"></i> Beranda
						</a>                
					</li>
					<li class="nav-item">
						<a class="nav-link  " href="<?= base_url() ?>super/profile" data-target="#navDashboard" aria-expanded="false" aria-controls="navDashboard">
					...
					<li class="nav-item">
						...
						<div id="navCourses"  class="collapse "  data-parent="#sideNavbar">
							<ul class="nav flex-column">
								<li class="nav-item">
									<a class="nav-link " href="<?= base_url();?>pages/dashboard/super-course-overview.html">
										Semua Kegiatan
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link " href="<?= base_url();?>pages/dashboard/super-course-category.html">
										Courses Category
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link " href="<?= base_url();?>pages/dashboard/super-course-category-single.html">
										Category Single
									</a>
								</li>
							</ul>
					...
					<li class="nav-item">
						...
						<div id="navProfile" class="collapse " data-parent="#sideNavbar">
							<ul class="nav flex-column">
								<li class="nav-item">
									<a class="nav-link " href="<?= base_url();?>super/admin_user">Admin</a>
								</li>	
								<li class="nav-item">
									<a class="nav-link " href="<?= base_url();?>super/mentor_user">Mentor</a>
								</li>
								<li class="nav-item">
									<a class="nav-link " href="<?= base_url();?>super/peserta_user">Peserta</a
										>
									</li>
								</ul>
							</div>
                   ...
                   <!--  <li class="nav-item ">
                    ...
                    <div id="navCMS" class="collapse  " data-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link   " href="<?= base_url();?>pages/dashboard/super-cms-overview.html">
                                    Overview
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  " href="<?= base_url();?>pages/dashboard/super-cms-post.html">
                                    All Post
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="<?= base_url();?>pages/dashboard/super-cms-post-new.html">
                                    New Post
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="<?= base_url();?>pages/dashboard/super-cms-post-category.html">
                                    Category
                                </a>
                            </li>
                        </ul>
					...
					<li class="dropdown ml-2">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownUser">
							...
							<ul class="list-unstyled">                       
								<li>
									<a class="dropdown-item" href="<?= base_url();?>super/profile">
